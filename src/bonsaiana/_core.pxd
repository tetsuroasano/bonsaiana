...
cdef extern from "lib/SnapIO.hpp" namespace "snapio":
    cdef cppclass SnapIO:
        SnapIO()

        void read_bonsai(string, int, int,  vector[long long]&, vector[int]&, vector[float]&, vector[float]&, vector[float]&, vector[long long]&, vector[int]&, vector[float]&, vector[float]&, vector[float]&)
